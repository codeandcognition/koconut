...
class CodeParser {
  ...
  static clean(code: string): string {
    ...
    return code.replace(new RegExp(Object.keys(_tags).join("|"), 'g'), '');
  }
            ...
            switch(tag) {
              ...
              case(_tags.START):
                ...
                if(start.row !== undefined || start.column !== undefined) {
                  throw { message: 'Repeated START tag in code' };
                }
              ...
              case(_tags.END):
                ...
                if(end.row !== undefined || end.column !== undefined) {
                  throw { message: 'Repeated END tag in code' };
                }
                ...
                ranges.push(new Range(start.row, start.column, end.row, end.column));
